...
<head>
    ...
    <title>Zetech University - Timetable</title>
...
<body>
    ...
    <div class="sidebar collapsed" id="sidebar">
        <ul class="sidebar-links">
            ...
            <a class="text-decoration-none text-light active-link" href="timetable.php">
                <li><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" width="30px" height="30px" stroke="currentColor" class="sidebar-icon">
    ...
    <div class="container_fluid mt-5 p-2" style="margin-left: 100px;">
        <h2 class="my-4">Your Timetable</h2>
            ...
            <table class="table table-bordered text-center">
                <thead class="table-primary">
                    <tr>
                        ...
                        <th>11:00 AM - 14:00 PM</th>
                        <th>14:00 PM - 17:00 PM</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td>Tuesday</td>
                        <td>GITONGA MUNYI DSE 312 <br>Cloud Computing ONLINE8</td>
                        <td></td>
                        <td>NICHOLAS OYUGI<br> DCU 113 Entrepreneurship and Innovation L204</td>
                    </tr>
                    <tr>
                        <td>Wednesday</td>
                        <td></td>
                        <td>FRANCIS MUTUKU<br> DSE 315 Computer Systems Project L205</td>
                        <td>FRANCIS MUTUKU<br> DSE 313 Artificial Inteligence L205</td>
                    </tr>
                    <tr>
                        <td>Thursday</td>
                        <td></td>
                        <td>PJORN MURIUKI<br> DSE 311 Mobile Programming A303 LAB</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>Friday</td>
                        <td>NANCY MUTHUI <br>DCS 312 Computer Security ONLINE38</td>
                        <td>KENNEDY GITHAIGA <br>DSE 502 Data Structures Algorithms A303 LAB</td>
                        <td></td>
                    </tr>
                </tbody>
            </table>
