...
// Fetch the number of units the student is registered for
$sqlUnits = "SELECT COUNT(*) AS registered_units FROM units WHERE course_id = '$courseId'";
$resultUnits = mysqli_query($conn, $sqlUnits);
$unitData = mysqli_fetch_assoc($resultUnits);
$registeredUnits = $unitData['registered_units'];
    ...
    <nav class="sticky-navbar">
        ...
        <div class="sidebar collapsed" id="sidebar">
            <ul class="sidebar-links">
                <a class="text-decoration-none text-light active-link" href="index.php">
        ...
        <div class="container_fluid mt-5 p-2" style="margin-left: 100px;">
            <div class="row my-4">
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm d-flex flex-column" style="height: 100%;">
                        <div class="card-body text-center">
                            <h5 class="card-title">Unit Registration</h5>
                            <p>Registered Units: <strong><?php echo $registeredUnits; ?></strong></p>
                            <a href="units.php" class="btn btn-success">View Units</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm d-flex flex-column" style="height: 100%;">
                        <div class="card-body text-center">
                            <h5 class="card-title">Timetable Overview</h5>
                            <p>Today: <strong>Algorithms (10:00 AM - 12:00 PM)</strong></p>
                            <p>Next Class: <strong>Operating Systems (1:00 PM - 3:00 PM)</strong></p>
                            <a href="#" class="btn btn-info">View Full Timetable</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">Unit registration deadline is <strong>October 15th, 2024</strong>.</li>
                                <li class="list-group-item">Upcoming event: <strong>ZU GDSC event on November 1st, 2024</strong>.</li>
                                <li class="list-group-item">New elective unit: <strong>Artificial Intelligence</strong> added for 3rd Year students.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item"><a href="registration.php">Units</a></li>
                                <li class="list-group-item"><a href="timetable.php">View Timetable</a></li>
